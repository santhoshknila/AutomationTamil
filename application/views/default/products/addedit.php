						...
						<div class="row ">
							<div class="col-sm-4 mg-t-10 mg-sm-t-0">
								...
								<div class="row mg-t-10">
									...
									<textarea class="form-control" id="newsFormspacetextarea" name="news[description]" placeholder="" cols="30" rows="3" ><?php echo (!empty($news) && $news->description!='')?$news->description:'';?></textarea>
								</div>
							</div>	
											...
											<tr id="row<?PHP echo $i; ?>" class="newsUploadfiles">
												...
												<td>
													...
													<div class="uploadUrl<?PHP echo $i; ?>">
														<div class="form-group">
															<input class="form-control" type="text" name="filehiddenPathURl[<?PHP echo $i; ?>]" value="<?PHP echo $media['imagevideo_url']; ?>" placeholder="Upload URL" id="filehiddenPathUrl<?PHP echo $i; ?>" readonly />
														</div>
													</div>
													<?PHP } ?>
												</td>
						...
						<div class="row mg-t-30">
							<div class="col-sm-12 mg-l-auto">
								<div class="form-layout-footer">
									...
									<input type="submit" name="submit" value="<?php if(!empty($news) && $news->newsFeedsId !=''){ echo "Update News"; }else{ echo "Add News"; } ?>" class="btn btn-primary waves-effect pull-right" />
