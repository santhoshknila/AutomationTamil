		...
		if($method != 'POST'){
			...
			if($post){
				...
				if(empty($message)){
					...
					$headers = "From: info@tamilchamber.org.za" . "\r\n";
								...
								<table width="650px" cellspacing="0" cellpadding="3" class="container" style="padding:40px;background-color:#eee;">
									<tr>
										<td>
											...
											<p style="font-size:14px;line-height:20px;">If you have any questions, please contact admin at <a href="mailto:info@tamilchamber.org.za">info@tamilchamber.org.za</a></p>
										</td>
									</tr>
								</table>
							</td>
